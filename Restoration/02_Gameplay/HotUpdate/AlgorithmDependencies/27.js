...
// Module: 27; dependency map: {"./cipher-core":4,"./core":5,"./enc-base64":6,"./evpkdf":9,"./md5":14}
module.exports = function(e, t, a) {
this, i = function(e) {
(function() {
var t = e, a = t.lib.StreamCipher, i = t.algo, o = [], n = [], s = [], r = i.Rabbit = a.extend({
_doReset: function() {
for (var e = this._key.words, t = this.cfg.iv, a = 0; a < 4; a++) e[a] = 16711935 & (e[a] << 8 | e[a] >>> 24) | 4278255360 & (e[a] << 24 | e[a] >>> 8);
...
this._b = 0;
for (a = 0; a < 4; a++) l.call(this);
for (a = 0; a < 8; a++) o[a] ^= i[a + 4 & 7];
if (t) {
