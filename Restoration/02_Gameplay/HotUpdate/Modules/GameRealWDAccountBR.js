...
// Module: GameRealWDAccountBR; dependency map: {"../BaseUIManager/BaseUI":"BaseUI","../BaseUIManager/Storage/GameLocalData":"GameLocalData","../BaseUIManager/Storage/PlayData":"PlayData","../BaseUIManager/Storage/TouchButton":"TouchButton","../BaseUIManager/UIConfig":"UIConfig","../BaseUIManager/UIManagerNew":"UIManagerNew","../HWL/ServerConfig":"ServerConfig","../LanguageControl/GameManagement":"GameManagement","../LanguageControl/Lab":"Lab","./AccountCheckManager":"AccountCheckManager","./GameRealWDDialog":"GameRealWDDialog"}
module.exports = function(e, t, a) {
"use strict";
cc._RF.push(t, "6e7319A1XtHf6EpdaFmPjUO", "GameRealWDAccountBR");
...
this.TaxIDEdit.node.on("text-changed", () => {
this.checkBtn();
});
this.btnLabel.node.parent.addComponent(r.default).registerTouchEvent(() => {
let e = n.default.getInstance().getData(s.default);
if (e.realSelectPlatform == d.RealCashPlatform.PIX) {
let t = this.validatePixAcc(this.accountEdit.string), a = g.default.validateAccount(this.nameEdit.string).valid, i = g.default.validateCPFJ(this.TaxIDEdit.string).valid;
if (!(t && a && i)) {
...
e.rdocumentId = this.TaxIDEdit.string;
} else {
let t = g.default.validateEmail(this.accountEdit.string).valid, a = g.default.validateAccount(this.nameEdit.string).valid, i = g.default.validateCPFJ(this.TaxIDEdit.string).valid;
if (!(t && a && i)) {
let e = u.default.getlab("14");
c.default.show_toast({
text: e
...
console.log(" 平台   ", this._tempPlatform, this._currentPlatform, this.param.allConditionsMet);
...
this.TaxIDLabel.string = u.default.getlab("97");
...
if ("" == this.player.rdocumentId) {
this.TaxIDEdit.placeholder = u.default.getlab("20");
this.TaxIDEdit.string = "";
} else {
this.TaxIDEdit.placeholder = this.player.rdocumentId;
this.TaxIDEdit.string = this.player.rdocumentId;
}
...
this.platfroms[1].node.active = 2 == this.platformSpr.length;
...
validatePixAcc(e) {
let t = g.default.validateEmail(e).valid, a = g.default.validatePhone55(e).valid, i = g.default.validateCPFJ(e).valid, o = g.default.validatePix(e).valid, r = n.default.getInstance().getData(s.default);
if (t) r.raccountType = "E"; else if (a) r.raccountType = "P"; else if (i) r.raccountType = "C"; else {
if (!o) return !1;
r.raccountType = "B";
}
n.default.getInstance().saveToUserDefault();
...
checkBtn() {
const e = this.accountEdit.string.length > 0 && this.nameEdit.string.length > 0 && this.TaxIDEdit.string.length > 0, t = this.confirmBtn.getComponent(cc.Sprite);
...
i([ m(cc.Label) ], y.prototype, "TaxIDLabel", void 0);
i([ m(cc.EditBox) ], y.prototype, "TaxIDEdit", void 0);
...
y = i([ o.registerUIPath("GameDialog/GameRealWDAccountBR"), f ], y);
a.default = y;
cc._RF.pop();
};
