...
namespace CoinMerge.Recovery.Editor
{
    ...
    [InitializeOnLoad] public static class VisualAuditStartup
    {
        const string Key="CoinMerge.VisualAudit.Startup",Prefix="coinmerge.visualaudit.startup.disposable";
        ...
        static string Output=>Path.GetFullPath("Design/VisualAudit20260917/Startup");
        static VisualAuditStartup(){EditorApplication.update+=Poll;EditorApplication.playModeStateChanged+=State;}
        static void Poll()
        {
            string file=File.Exists("Temp/VisualAuditStartupBaseline.request")?"Temp/VisualAuditStartupBaseline.request":"Temp/VisualAuditStartup.request";
        ...
        [MenuItem("Coin Merge/Reskin/Audit current startup presentation")]
