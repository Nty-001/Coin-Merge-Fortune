...
{
    [InitializeOnLoad] public static class VisualAuditPages
    {
        const string Key="CoinMerge.VisualAudit.Pages",Prefix="coinmerge.visualaudit.pages.disposable";
        ...
        static string Output=>Path.GetFullPath("Design/VisualAudit20260917/Current");
