...
{
    [InitializeOnLoad] public static class MergeFeedbackValidation
    {
        const string Key="CoinMerge.MergeFeedbackCheck",Prefix="coinmerge.merge.feedback.disposable";
        ...
        static MergeFeedbackValidation(){EditorApplication.playModeStateChanged+=State;}
        ...
        static void Finish(string error)
        {
            ...
            File.WriteAllText("../07_Verification/merge_feedback_validation.json",JsonUtility.ToJson(new Report {passed=error==null,error=error,checks=checks.ToArray()},true));
