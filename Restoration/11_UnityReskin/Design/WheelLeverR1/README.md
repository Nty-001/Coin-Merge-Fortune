...
- 机身、金属杆、球头是透明 PNG 与预制体中的独立 Image。球头已在后续 R2 中清除原裁切残留的金属杆头，详见 `../WheelJointR2/README.md`。没有新增点击区域；仍由原抽奖 Button 和积分判断触发。
...
初版球头采用原已认可素材的裁切；后续 R2 清除了裁切底部的金属残留。当前脚本复用 `../WheelJointR2/ApprovedKnob.png`，避免重新引入接缝。
